...
TEST(pso_gen_test, construction)
{
    ...
    EXPECT_THROW((pso_gen{100, -0.79, 2., 2., 0.1, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);
    EXPECT_THROW((pso_gen{100, 2.3, 2., 2., 0.1, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);

    EXPECT_THROW((pso_gen{100, 0.79, -1., 2., 0.1, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);
    EXPECT_THROW((pso_gen{100, 0.79, 2., -1., 0.1, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);
    EXPECT_THROW((pso_gen{100, 0.79, 5., 2., 0.1, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);
    EXPECT_THROW((pso_gen{100, 0.79, 2., 5., 0.1, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);

    EXPECT_THROW((pso_gen{100, 0.79, 2., 2., -2.3, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);
    EXPECT_THROW((pso_gen{100, 0.79, 2., 2., 1.1, 5u, 2u, 4u, false, 23u}), invalid_parameter_error);

    EXPECT_THROW((pso_gen{100, 0.79, 2., 2., 0.1, 8u, 2u, 4u, false, 23u}), invalid_parameter_error);
    EXPECT_THROW((pso_gen{100, 0.79, 2., 2., 0.1, 0u, 2u, 4u, false, 23u}), invalid_parameter_error);

    EXPECT_THROW((pso_gen{100, 0.79, 2., 2., 0.1, 5u, 6u, 4u, false, 23u}), invalid_parameter_error);
    EXPECT_THROW((pso_gen{100, 0.79, 2., 2., 0.1, 5u, 0u, 4u, false, 23u}), invalid_parameter_error);

    EXPECT_THROW((pso_gen{100, 0.79, 2., 2., 0.1, 5u, 2u, 0u, false, 23u}), invalid_parameter_error);
}

TEST(pso_gen_test, evolve_test)
{
    // We then check that the evolve throws if called on unsuitable problems
    EXPECT_THROW(pso_gen{10u}.evolve(population{problem{rosenbrock{}}}), insufficient_population_error);
    EXPECT_THROW(pso_gen{10u}.evolve(population{problem{zdt{}}, 15u}), incompatible_problem_error);
    EXPECT_THROW(pso_gen{10u}.evolve(population{problem{hock_schittkowski_71{}}, 15u}), incompatible_problem_error);
